  ...
  return (
    <div className="container">
      <div className="nir">
        ...
        <p className="nir__text">
          <img className="nir__text-img" src={tmp} alt="" />
          ...
          лабораторным работам, курсовых работ, выпускных квалификационных работ (выпускная работа бакалавра, дипломная
